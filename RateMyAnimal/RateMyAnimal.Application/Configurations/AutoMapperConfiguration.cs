...
namespace RateMyAnimal.Application.Configurations
{
    public class AutoMapperConfiguration : Profile
    {
        public AutoMapperConfiguration()
        {
            ...
            CreateMap<AnimalCategoryViewModel, AnimalCategory>().ReverseMap();
            CreateMap<AnimalCategory, int>().ConvertUsing(x => x.CategoryId);
            CreateMap<int, AnimalCategory>().ForPath(a => a.CategoryId, o => o.MapFrom(r => r));
            #endregion
            ...
            CreateMap<Category, CategoryViewModel>()
                ...
                .ForMember(a => a.AnimalCategories, o => o.MapFrom(r => r.AnimalCategories))
                .ReverseMap();
            #endregion
        }
